...
#             #read data from train and test, as static method calling use class method
...
class DataValidation:
    ...
    def initiate_data_validation(self) -> DataValidationArtifact:
        ...
        try:
            ...
            if not status:
                error_message += ("Dataframe does not contain all columns.\n")
            ...
            dataframe.to_csv(self.data_validation_config.valid_train_file_path,index=False,header=True)
