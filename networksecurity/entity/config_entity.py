...
class DataIngestionConfig:
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        #here finally both pointing to constant->training_pipeline init.py
...
class DataTransformationConfig:
     def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        ...
        # Mapping directory
        self.mapping_dir = os.path.join(self.data_transformation_dir,
            training_pipeline.DATA_TRANSFORMATION_MAPPING_DIR
        )
        # Student mapping path
        self.student_mapping_file_path = os.path.join(self.mapping_dir,
            training_pipeline.STUDENT_MAPPING_FILE_NAME
        )
        # Tracker mapping path
...
class ModelTrainerConfig:
    ...
    def __init__(self,training_pipeline_config: TrainingPipelineConfig):
        ...
        # Expected R2 score
        self.expected_r2_score: float = (
            training_pipeline.MODEL_TRAINER_EXPECTED_R2_SCORE
        )
        # Allowed train-test metric gap
